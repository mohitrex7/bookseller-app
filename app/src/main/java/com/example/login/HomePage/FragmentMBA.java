...
public class FragmentMBA extends Fragment {
    private RecyclerView mbaRecyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_mba, container, false);

        books = new ArrayList<>();

        mbaRecyclerView = v.findViewById(R.id.mbaRecyclerView);
        ...
        String uri = "@drawable/pythonbook";  // where myresource (without the extension) is the file
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, urlaaa,null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONArray array = response.getJSONArray("mba");
        ...
        mbaRecyclerView.setLayoutManager(mLayoutmanager);
        mbaRecyclerView.setAdapter(mAdapter);
