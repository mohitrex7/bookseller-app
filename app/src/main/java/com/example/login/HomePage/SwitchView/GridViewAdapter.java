...
public class GridViewAdapter extends BaseAdapter implements Filterable {
    ...
    FilterHelperForGrid filterHelperForGrid;

    public GridViewAdapter(Context c, ArrayList<Product> products) {
        this.c = c;
    ...
    public Filter getFilter() {
        if(filterHelperForGrid ==null)
        {
            filterHelperForGrid =new FilterHelperForGrid(currentList,this,c);
        }

        return filterHelperForGrid;
    }
    public void refresh(){
